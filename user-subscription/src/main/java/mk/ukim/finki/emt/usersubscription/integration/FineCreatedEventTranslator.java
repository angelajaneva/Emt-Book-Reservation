...
@Service
public class FineCreatedEventTranslator implements RemoteEventTranslator {
    private final ObjectMapper objectMapper;

    FineCreatedEventTranslator(ObjectMapper objectMapper) {
    ...
    public boolean supports(StoredDomainEvent remoteEvent) {
        return remoteEvent.domainEventClassName().equals("mk.ukim.finki.emt.finemanagement.domain.event.FineCreated");
    }

    @Override
    public Optional<DomainEvent> translate(StoredDomainEvent remoteEvent) {
        return Optional.of(remoteEvent.toDomainEvent(objectMapper, FineCreatedEvent.class));
    }
}
