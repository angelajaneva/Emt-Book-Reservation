...
public class DataGenerator implements CommandLineRunner {
    ...
    @Autowired
    private BookCatalog bookRepository;
    @Autowired
    private ReservationCatalog reservationRepository;

//    public DataGenerator(BookCatalog bookRepository, ReservationCatalog reservationRepository, ApplicationEventPublisher applicationEventPublisher) {
